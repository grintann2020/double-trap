...
namespace DT {
    ...
    public class VwPrm : IVwPrm {
        ...
        // private SCamPrj[] _sPrjArr = new SCamPrj[Enum.GetNames(typeof(EPrj)).Length];
        ...
        public VwPrm() {
            ...
            _iVwArr[(byte)EVw.Fst] = new FstVw();
            _iVwArr[(byte)EVw.Play] = new PlayVw();
        }
    }
}